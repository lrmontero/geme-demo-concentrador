...
El administrador puede editar los estados "Administrador Gestionando" y "En Analisis"

Si CREADO_POR es "Solicitante"
Header
1. Categoría: Estado - Nombre de Campo: ESTADO - Label: Estado - Tipo de Dato: Línea de Texto - Descripción: En esté modulo se deberá actualizar el estado en que está cada solicitud, estos estados serán los siguientes: (En Análisis, Administrador Gestionando) - Obligatoriedad: ✅ Lectura. Habilitado para editar en "Administrador Gestionando" o "En Análisis"
...
Identificación
3. Categoría: Identificación - Nombre de Campo: ID_SOLICITUD - Label: ID Solicitud - Tipo de Dato: Línea de Texto - Descripción: Id de la solicitud (CEN o SODI), Este será el número asignado por la solicitud del CEN o SODI, sirviendo como identificador del trabajo. - Obligatoriedad: ✅ Opcional
...
Si CREADO_POR es "Administrador"

Header
1. Categoría: Estado - Nombre de Campo: ESTADO - Label: Estado - Tipo de Dato: Línea de Texto - Descripción: En esté modulo se deberá actualizar el estado en que está cada solicitud, estos estados serán los siguientes: (Administrador Gestionando) - Obligatoriedad: ✅ Lectura. Habilitado para editar en "Administrador Gestionando"
2. Categoría: Estado - Nombre de Campo: OBSERVACIONES - Label: Observaciones - Tipo de Dato: Múltiples Lineas de Texto - Descripción: En cada cambio de estado se debe incluir una observacion obligatoria. - Obligatoriedad: ✅ Lectura
