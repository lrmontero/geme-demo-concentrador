...
El solicitante puede editar los siguientes campos solo en estado Devuelto

Header
ver -> 1 - Nombre campo: ESTADO - label: Estado - Descripción: Se crea en estado Pendiente
ver -> 2 - Nombre campo: OBSERVACIONES - label: Observaciones - Descripción: En cada cambio de estado se debe incluir una observacion obligatoria.
